...
try:
	log_df = pd.read_csv(os.path.join("AutoFC_InceptionV3", "AutoFC_InceptionV3_log_Corel_1k_grid_search_v1.csv"), header=0)
...
#print(log_df.head())
		log_df.to_csv(os.path.join("AutoFC_InceptionV3", "AutoFC_InceptionV3_log_Corel_1k_grid_search_v1.csv"))
