...
try:
    log_df = pd.read_csv(os.path.join("AutoFC_VGG16", "AutoFC_VGG16_log_Corel_1k_random_search_v1.csv"), header=0, index_col=['index'])
...
#print(log_df.head())
        log_df.to_csv(os.path.join("AutoFC_VGG16", "AutoFC_VGG16_log_Corel_1k_random_search_v1.csv"))
