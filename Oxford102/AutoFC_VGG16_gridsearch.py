...
try:
	log_df = pd.read_csv(os.path.join("AutoFC_VGG16", "AutoFC_VGG16_log_Oxford102_grid_search_v1.csv"), header=0)
...
#print(log_df.head())
		log_df.to_csv(os.path.join("AutoFC_VGG16", "AutoFC_VGG16_log_Oxford102_grid_search_v1.csv"))
