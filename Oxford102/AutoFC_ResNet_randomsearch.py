...
RESULTS_PATH = os.path.join("AutoFC_ResNet", "AutoFC_ResNet_log_Oxford102_random_search_v1.csv") # The path to the results file
...
param_grid = {
    ...
    'num_layers': range(0, 4) # the possible number of layers that can be used in the model
}
...
for i in num_layers:
    ...
    for j in temp_store: # iterate over the list of sampled configurations
        ...
        base_model = ResNet50(weights="imagenet") # make an instance of an existing architecture to start the experiment
