...
try:
    log_df = pd.read_csv(os.path.join("AutoFC_MobileNet", "AutoFC_MobileNet_log_ucm-land_bayes_opt_v1.csv"), header=0, index_col=['index'])
...
for combo in p_space:
    ...
    log_df.to_csv(os.path.join("AutoFC_MobileNet", "AutoFC_MobileNet_log_ucm-land_bayes_opt_v1.csv"))
