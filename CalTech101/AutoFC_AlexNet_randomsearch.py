...
try:
    log_df = pd.read_csv(os.path.join("AutoFC_AlexNet", "AutoFC_AlexNet_log_CalTech_101_random_search_v1.csv"), header=0, index_col=['index'])
...
#print(log_df.head())
        log_df.to_csv(os.path.join("AutoFC_AlexNet", "AutoFC_AlexNet_log_CalTech_101_random_search_v1.csv"))
