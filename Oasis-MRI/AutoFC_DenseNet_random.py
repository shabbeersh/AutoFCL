...
try:
    log_df = pd.read_csv(os.path.join("AutoFC_DenseNet", "AutoFC_DenseNet_log_oasis-mri_random_search_v1.csv"), header=0, index_col=['index'])
...
#print(log_df.head())
        log_df.to_csv(os.path.join("AutoFC_DenseNet", "AutoFC_DenseNet_log_oasis-mri_random_search_v1.csv"))
